...
pros::Motor mtr_claw(3, pros::E_MOTOR_GEAR_BLUE, false, pros::E_MOTOR_ENCODER_DEGREES);

pros::Motor_Group left_drive({mtr_lf, mtr_lb, mtr_lbh});
pros::Motor_Group right_drive({mtr_rf, mtr_rb, mtr_rbh});

pros::ADIDigitalOut clawLeft(1, false);
pros::ADIDigitalOut clawRight(2, false);
